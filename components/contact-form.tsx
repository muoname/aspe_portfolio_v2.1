  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder={styleMode === "game" ? "Enter your adventurer name..." : "Enter your name..."}
              required
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-background border border-primary/20 rounded-lg focus:border-primary/40 focus:outline-none transition-colors"
              placeholder={styleMode === "game" ? "your.crystal@realm.com" : "your.email@example.com"}
              required
            />
          </div>
        </div>
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-primary">{styleMode === "game" ? "Quest Title" : "Subject"}</label>
          <input
            type="text"
            value={formData.subject}
            onChange={(e) => handleInputChange("subject", e.target.value)}
            className="w-full px-3 py-2 bg-background border border-primary/20 rounded-lg focus:border-primary/40 focus:outline-none transition-colors"
            placeholder={styleMode === "game" ? "What's this quest about?" : "What's this regarding?"}
            required
          />
        </div>
