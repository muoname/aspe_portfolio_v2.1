...
export function ProjectsSection({ styleMode, onProjectClick }: ProjectsSectionProps) {
  ...
  const categories = ["all", "Web Application", "Mobile App", "Analytics", "Blockchain", "AI/ML", "Productivity Tool"]
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center space-x-3">
        <h2 className="text-3xl font-bold text-primary">{styleMode === "game" ? "Quest Log" : "Projects Portfolio"}</h2>
