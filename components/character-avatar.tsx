            ...
            <div className="space-y-2">
              ...
              <div className="w-full bg-muted rounded-full h-3 border border-primary/20 overflow-hidden">
                <div
                  ...
                  style={{
                    width: barsAnimated ? `${(characterStats.experience / characterStats.nextLevelExp) * 100}%` : "0%",
                    boxShadow: "inset 0 1px 2px rgba(255,255,255,0.3), 0 0 8px rgba(var(--primary), 0.4)",
                  }}
                >
