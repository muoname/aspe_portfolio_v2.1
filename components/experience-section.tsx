  ...
  const experiences: Experience[] = [
    {
      ...
      skills: ["Full Stack Development", "API Design", "Database Optimization", "CI/CD", "Mentoring"],
      ...
      projects: [
        ...
        },
        {
          ...
          description: "Developed a real-time task management application using React and Socket.io",
    ...
    },
    {
      ...
      skills: ["Full Stack Development", "API Design", "Database Optimization", "CI/CD", "Teamwork"],
    ...
    },
    {
      ...
      skills: ["Frontend Development", "Responsive Design", "Cross-Browser Compatibility", "UI/UX Design", "Teamwork"],
                  ...
                  <div className="space-y-2">
                    ...
                    {selectedExperience === experience.id && (
                      <div className="pt-4 border-t border-primary/20 space-y-3">
                        <h4 className="text-sm font-semibold text-primary mb-2">Key Responsibilities:</h4>
