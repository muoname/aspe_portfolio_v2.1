    ...
    >
      ...
      >
        ...
        <Card className="lg:col-span-3 p-6 bg-card/80 backdrop-blur-sm border-primary/20 relative overflow-hidden">
          ...
          >
            {activeTab === "profile" && <ProfileSection styleMode={styleMode} terminology={terminology} />}
            {activeTab === "skills" && <SkillsSection styleMode={styleMode} />}
            {activeTab === "projects" && <ProjectsSection styleMode={styleMode} onProjectClick={onProjectClick} />}
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div className="space-y-6">
          <CharacterAvatar styleMode={styleMode} characterStats={characterStats} barsAnimated={barsAnimated} />
          <CharacterInfo styleMode={styleMode} characterStats={characterStats} />
        </div>

        {/* Character Stats */}
        <CharacterStats styleMode={styleMode} barsAnimated={barsAnimated} attributes={characterStats.attributes} />
